    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
            ...
            errorBuilder: (context, error) {
              return Center(
                child: Column(
                  ...
                  children: [
                    Icon(Icons.camera_alt, size: 64, color: theme.colorScheme.onSurface.withOpacity(0.5)),
                    const SizedBox(height: 16),
                    Text(
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isDark ? Colors.grey[900]!.withOpacity(0.8) : Colors.black.withOpacity(0.7),
          ...
          if (_isLoading)
            Container(
              color: isDark ? Colors.grey[900]!.withOpacity(0.7) : Colors.black.withOpacity(0.5),
              child: Center(
                child: Column(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: [
